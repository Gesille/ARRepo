...
exports.checkUserRole = exports.deleteUser = exports.updateUserRole = exports.getAllUsers = exports.updateProfilePicture = exports.updatePassword = exports.socialAuth = exports.getUserInfo = exports.updateUserInfo = exports.updateAccessToken = exports.logoutUser = exports.loginUser = exports.activateUser = exports.createActivationToken = exports.registrationUser = void 0;
...
exports.activateUser = (0, catchAsyncError_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newUser = jsonwebtoken_1.default.verify(activation_token, process.env.ACTIVITION_SECRET);
        ...
        return next(new ErrorHandler_1.default(error.message || "Something went wrong", 400));
    }
}));
...
exports.updatePassword = (0, catchAsyncError_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!oldPassword || !newPassword) {
            return next(new ErrorHandler_1.default("Please inter your old and new password", 400));
        }
        ...
        yield (user === null || user === void 0 ? void 0 : user.save());
        yield user_model_1.default.findByIdAndUpdate((_b = req.user) === null || _b === void 0 ? void 0 : _b._id, user);
        res.status(201).json({
            success: true,
            user,
        });
...
exports.getAllUsers = (0, catchAsyncError_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (userRole !== 'admin') {
            return next(new ErrorHandler_1.default("You are not authorized to view all users", 403));
        }
...
exports.updateUserRole = (0, catchAsyncError_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const userRole = (_a = req.user) === null || _a === void 0 ? void 0 : _a.role;
        if (userRole !== 'admin') {
            return next(new ErrorHandler_1.default("You are not authorized to update user roles", 403));
        }
...
exports.deleteUser = (0, catchAsyncError_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const userRole = (_a = req.user) === null || _a === void 0 ? void 0 : _a.role;
        if (userRole !== 'admin') {
            return next(new ErrorHandler_1.default("You are not authorized to delete users", 403));
        }
        const { id } = req.params;
        const user = yield user_model_1.default.findById(id);
        if (!user) {
            return next(new ErrorHandler_1.default("User not founf", 404));
        }
...
const checkUserRole = (role) => {
    return (req, res, next) => {
        var _a;
        const userRole = (_a = req.user) === null || _a === void 0 ? void 0 : _a.role; // جلب الدور من المستخدم
        if (userRole !== role) {
            return next(new ErrorHandler_1.default("You are not authorized", 403));
        }
        next();
    };
};
