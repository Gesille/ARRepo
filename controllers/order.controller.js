...
exports.createOrder = (0, catchAsyncError_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const courseExistsInUser = user === null || user === void 0 ? void 0 : user.courses.some((course) => (course === null || course === void 0 ? void 0 : course._id.toString()) === courseId);
        ...
        yield notification_Model_1.default.create({
            userId: user === null || user === void 0 ? void 0 : user._id,
            title: "New Order",
            message: `You have a new Order for ${course === null || course === void 0 ? void 0 : course.name}`,
        });
