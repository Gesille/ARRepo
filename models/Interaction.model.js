...
const UserInteractionSchema = new mongoose_1.Schema({
    userId: {
        type: mongoose_1.default.Schema.Types.ObjectId, // هنا يتم تحديد type بشكل صحيح
        ref: 'User', // إشارة إلى النموذج المستخدم
        required: true,
    },
    postId: {
        type: mongoose_1.default.Schema.Types.ObjectId, // تحديد النوع ObjectId بشكل صحيح
